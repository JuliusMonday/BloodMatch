const checkBloodCompatibility = () =>{
    ...
    switch(selectedBloodType) {
      ...
      case "AB-":
        ...
        diseaseProneTo.textContent = `You are prone to a non-specific; Maintaining a healthy lifestyle with a balanced diet, regular exercise, and adequate sleep is far more important for disease prevention.`
        break;
      case "O+":
