  ...
  const checkGenotypeCompatibility = () => {
    ...
    switch(selectedGenotype) {
      ...
      case "AS x SS":
        ...
        cannotMary.textContent = `SCD Risk in Offspring: No SCD risk for AA children, 25% chanc50% chance of SCD for both AS and SS childrene of SCD for SS children, 50% AS carriers`
      case "AS x SC":
